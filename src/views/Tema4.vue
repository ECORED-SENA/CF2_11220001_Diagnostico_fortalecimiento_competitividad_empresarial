  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 4
      h1 Recomendaciones y formulación de planes    
    ...
    #MapaGroup01(data-aos="zoom-in")
      ...
      .row.mb-5.justify-content-center
        .col-3.col-md-2.col-lg-1.mb-3.mb-lg-0(v-for="num of 6")
          button.ClasePripiaBtn.collapsed(
            :id="`boton${num}`"
            data-bs-toggle="collapse" 
            :data-bs-target="`#collapse${num < 7 ? '0'+num : num}, #collapse${num < 7 ? '0'+num : num}s`" 
            aria-expanded="true" 
            :aria-controls="`#collapse${num < 7 ? '0'+num : num}, #collapse${num < 7 ? '0'+num : num}s`"
          )
            img.img-a.boton_wid(:src="require(`@/assets/curso/tema_1/img_${num + 2}.svg`)", alt="")
          img.img-a.collapse(
            :id="`collapse${num < 7 ? '0'+num : num}s`"
      ...
      #collapse04.collapse(:class="{show: hash == 4}" data-bs-parent='#MapaGroup01')
        ...
        p El siguiente video explica secuencialmente estos pasos:
